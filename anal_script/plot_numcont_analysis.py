...
def plot_numcont_analysis(csv_file):
    """
    绘制接触数分析图
    
    参数:
        csv_file: 合并后的接触数数据 CSV 文件
    """
    ...
    ax.set_title('Number of Contacts Analysis', fontsize=18)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("用法：python plot_numcont_analysis.py <csv_file>")
        sys.exit(1)
    
    csv_file = sys.argv[1]
    plot_numcont_analysis(csv_file)
